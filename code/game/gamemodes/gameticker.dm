...
/datum/controller/gameticker/proc/pregame()
	...
	'sound/music/Doom_Theme_Song.ogg',\
	'sound/music/Eddie_Let_Me_Go_Back_To_My_Home.ogg',\
	'sound/music/Evangelion_-_A_Cruel_Angel_39_s_Thesis-_Bike_Horn_.ogg',\
	'sound/music/Kenny_Loggins_-_Danger_Zone.ogg',\
	'sound/music/Makai_Kingdom_Arrange_Album-_JOKER.ogg',\
	'sound/music/Modjo_-_Lady_ANDROID_-_APARTMENT_Remix_mp3.ogg',\
	'sound/music/Peter_Schilling_-_Major_Tom_-_Lyrics_-.ogg',\
	'sound/music/System_Shock_2_soundtrack_Engineering.ogg',\
	'sound/music/Luxury_Elite_-_All_Night_-_Mild_Seven.ogg',\
	'sound/music/Saint_Pepsi_-_Private_Caller.ogg',\
	'sound/music/Luxury_Elite_-_Shadows.ogg',\
	'sound/music/Luxury_Elite_-_Midnight.ogg',\
	'sound/music/SAINT_PEPSI_-_ENJOY_YOURSELF_Music_Video_.ogg',\
